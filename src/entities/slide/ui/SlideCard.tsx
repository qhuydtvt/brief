  ...
  return (
    <div className={`h-full w-full shrink-0 snap-start bg-gradient-to-br ${slide.bgColor} relative`}>
      ...
      <div className="mx-auto w-full max-w-lg h-full z-10 relative overflow-hidden px-3 pt-8 pb-3">
        ...
        <div className="absolute bottom-6 right-2 z-40 flex flex-col items-center gap-y-4 text-white bg-black/30 backdrop-blur-md p-2 rounded-2xl border border-white/10 shrink-0">
          {likeButtonSlot}
          {commentButtonSlot}
          {saveButtonSlot}
          {shareButtonSlot}
